  ...
  if (stage === 'pick') {
    ...
    return (
      <Frame
        ...
        subtitle="Apple’s list opens next. Qwyt never sees the names — only how many you picked."
        footer={
          <View style={s.footerStack}>
      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        {refusedSchedule ? (
          <Animated.View entering={FadeIn.duration(durations.fast)} exiting={FadeOut.duration(durations.fast)}>
            <Notice tone="info">The shield is up, but iOS didn’t take the timer. Qwyt lifts it the next time you open the app after it ends.</Notice>
          </Animated.View>
        ) : null}
      ...
      <Modal visible={managing} animationType="slide" presentationStyle="pageSheet" onRequestClose={() => setManaging(false)}>
        <SafeAreaView style={s.root} edges={['bottom']}>
          <ScrollView contentContainerStyle={s.content}>
            ...
            <Text style={s.fine}>Want it locked for real? In iOS Settings › Screen Time › Lock Screen Time Settings, a passcode stops Qwyt’s access being switched off — and the app being deleted — without it. Ask someone you trust to set the code.</Text>
