...
export default function SettingsScreen() {
  ...
  const confirmSignOut = () => {
    ...
    Alert.alert(
      'Sign out?',
      'Your subscription lives on your account, so you’ll need to sign back in to use Nocrave. Your streaks, slips and notes stay on this phone either way.',
      [
      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <Section label="Support">
          <Row
            ...
            iconWash={hues.urge.wash}
            label="Get help"
            sub="Crisis and addiction lines, and what Nocrave isn’t."
...
function ThemeRow() {
  ...
  const sub = !isExpoGo
    ? 'Switches instantly.'
    : pending
      ? 'Applies next time you open Nocrave.'
