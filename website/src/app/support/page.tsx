...
export const metadata = {
  title: 'Support',
  description: 'Get help with Qwyt: contact, FAQs, subscriptions, and managing your data.',
};
...
<Callout>
  ...
  <h3>What does Qwyt store, and for how long?</h3>
  ...
  <p><strong>iPhone/iPad:</strong> Settings → tap your name → Subscriptions → Qwyt → Cancel
  Subscription.<br />
  <strong>Android:</strong> Google Play → profile icon → Payments &amp; subscriptions →
  Subscriptions → Qwyt → Cancel.</p>
  ...
  <p>Check that notifications are allowed for Qwyt in your device settings, and that
  reminders are switched on in <em>Qwyt → Settings → Reminders</em>. Focus modes and battery
  ...
  <h3>Is Qwyt a substitute for treatment?</h3>
  <p>No. Qwyt is a self-tracking tool, not a medical device, and it doesn’t diagnose or treat
