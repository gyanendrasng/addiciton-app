...
export const metadata = {
  title: 'Terms of Use',
  description: 'Qwyt terms of use, subscription terms, and medical disclaimer.',
};
...
<Callout tone="danger">
    <p><strong>Qwyt is not medical care.</strong> Qwyt is not a medical device and does not
  ...
  <Callout tone="warn">
    ...
    life-threatening withdrawal. Do not use Qwyt as a reason to stop without medical
  ...
  (“we”, “us”) governing your use of the Qwyt mobile application and joincurb.app (together,
  the “Service”). By downloading, installing or using Qwyt (formerly published as “Curb”) you agree to these Terms. If you
  do not agree, do not use the Service.</p>
  <p>Qwyt is for adults. You must be at least 18 years old and able to form a binding
  contract. The app is not directed to anyone younger, and we do not knowingly provide the
  Service to them.</p>

  <h2 id="what">2. What Qwyt is</h2>
  <p>Qwyt helps you record and reduce addictive habits: it tracks streaks, offers a guided
  ...
  <ul>
    <li>Use Qwyt only for lawful, personal, non-commercial purposes.</li>
  ...
  <p>Qwyt requires a paid subscription. Where a free trial is offered, its length and the
  ...
  <p>You may stop using Qwyt at any time by deleting it. We may suspend or terminate access
