...
export const metadata = {
  ...
  description: 'How to permanently delete all of your Qwyt data.',
};
...
<Callout>
  ...
  <ol>
    <li>Open Qwyt and go to the <strong>Settings</strong> tab.</li>
  ...
  <p>If you turned on <em>Share usage data</em>, Qwyt has sent product analytics to PostHog:
  ...
  <p>Uninstalling Qwyt removes the app and the recovery history it keeps on the phone. It
  does not delete your account, your subscription record or your usage data — use options 1
  to 3 above for those.</p>
  <ul>
    <li><strong>iOS:</strong> press and hold the Qwyt icon → Remove App → Delete App.</li>
    <li><strong>Android:</strong> press and hold the Qwyt icon → App info → Uninstall.</li>
  </ul>
