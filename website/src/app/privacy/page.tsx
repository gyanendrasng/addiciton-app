...
export const metadata = {
  ...
  description: 'How Qwyt handles your data: what we collect, why, how long we keep it, and how to have it deleted.',
};
...
<Callout>
    <p><strong>The short version.</strong> Qwyt keeps your recovery record — habits,
  ...
  <div className="my-8 rounded-2xl bg-surface px-6 py-5">
    <ol>
      ...
      <li><a href="#ondevice">What Qwyt stores on your device</a></li>
  ...
  <p>Qwyt (“Qwyt”, formerly published as “Curb”, “we”, “us”) is a mobile application that helps people track and reduce
  addictive habits. This policy explains how the app handles information. It applies to
  the Qwyt iOS and Android apps and to this website, <strong>joincurb.app</strong>.</p>
  <p>
  ...
  <h2 id="ondevice">2. What Qwyt stores on your device</h2>
  <p>Qwyt stores the following in a local database inside the app’s private storage area
  ...
  Qwyt an opaque reference to your selection, not the names of the apps or sites, and Qwyt
  ...
  <Callout tone="warn">
    ...
    JSON file of your Qwyt data that you can store wherever you like. Don’t rely on us to
  ...
  <p>Qwyt requires an account so that a subscription you buy on one phone works on your
  ...
  <p>Qwyt offers a paid subscription and a one-time lifetime option. Payment is handled
  ...
  <p>Qwyt can receive improvements and fixes without a full store update, using{' '}
  ...
  <p>Qwyt’s reminders (a morning pledge and an evening check-in) are <strong>local
  ...
  <p>Settings → <em>Export everything</em> writes a JSON file containing your Qwyt data and
  ...
  process personal information for cross-context behavioural advertising. Qwyt contains no
  ...
  <p>Qwyt does not track you across other companies’ apps or websites, and does not request
  ...
  UK/EU GDPR.</p>
  <p>Because your Qwyt data lives on your own device and is never sent to us, most of these
  ...
  <p>Qwyt is for adults and is not directed to children. The Terms require you to be at
  ...
  <p>Qwyt’s database is stored inside the app’s private container, protected by your
  ...
  changes, notify you in the app. Continuing to use Qwyt after a change means you accept
