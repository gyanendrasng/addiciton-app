...
export default function Page() {
  return (
    <LegalPage title={'If you need help right now'} updated={'Free, confidential, and available whether or not you use Qwyt.'}>
<Callout tone="danger">
  ...
  <Callout>
    <p>Qwyt is a self-tracking tool, not a treatment service, and cannot respond to
