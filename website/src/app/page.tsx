      ...
      <section id="how" className="border-t border-line py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <p className="mt-4 max-w-2xl text-dim">
            Most trackers count days. Nocrave is designed around the two minutes when a craving peaks
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="rounded-3xl border border-accent-deep bg-accent/[0.08] p-8 sm:p-10">
            <p className="mb-4 text-[13px] font-semibold uppercase tracking-[0.14em] text-accent">
              Why Nocrave is different
            </p>
            <h2 className="text-[clamp(26px,3.6vw,36px)] font-extrabold">
              Built to be used at 2am, not shown off.
            </h2>
            <p className="mt-4 max-w-2xl text-dim">
              Most quitting apps count days. Nocrave is built for the minute the count is about
            ...
            <p className="mt-6 text-sm text-faint">
              What Nocrave collects, and how long it is kept, is set out in the{' '}
      ...
      <section className="border-t border-line py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-6">
          <div className="max-w-2xl">
            <h2 className="text-[clamp(30px,4.4vw,42px)] font-extrabold">
              Nocrave is a self-tracking tool, not treatment.
            </h2>
            <p className="mt-4 text-dim">
              Nocrave is not a medical device and does not diagnose, treat, cure, or prevent any
